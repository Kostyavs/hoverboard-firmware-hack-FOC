...
*/
  ...
  #define PRI_INPUT1          2, -500, 0, 500, 25    // Disabled. TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define PRI_INPUT2          2, -500, 0, 500, 25   // Active.   TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
