...
#define N_MOT_MAX       2000 //127  //8 km/h  // [rpm] Maximum motor speed limit
...
#define PHASE_ADV_MAX   75              // [deg] Maximum Phase Advance angle (only for SIN). Higher angle results in higher maximum speed.
...
*/
  ...
  #define PRI_INPUT1          2, -1500, 0, 1500, 100    // Disabled. TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define PRI_INPUT2          2, -1500, 0, 1500, 100   // Active.   TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
