...
*/
#define BOARD_VARIANT          0 // 0         // change if board with alternate pin mapping
...
#define BAT_LVL2                (3 * BAT_CELLS * BAT_CALIB_ADC) / BAT_CALIB_REAL_VOLTAGE    // Red:          gently beep at this voltage level. [V*100/cell]. In this case 3.60 V/cell
#define BAT_LVL1                (2 * BAT_CELLS * BAT_CALIB_ADC) / BAT_CALIB_REAL_VOLTAGE    // Red blink:    fast beep. Your battery is almost empty. Charge now! [V*100/cell]. In this case 3.50 V/cell
#define BAT_DEAD                (1 * BAT_CELLS * BAT_CALIB_ADC) / BAT_CALIB_REAL_VOLTAGE    // All leds off: undervoltage poweroff. (while not driving) [V*100/cell]. In this case 3.37 V/cell
// ######################## END OF BATTERY ###############################
...
#define I_DC_MAX        17    155          // [A] Maximum stage2 DC Link current limit for Commutation and Sinusoidal types (This is the final current protection. Above this value, current chopping is applied. To avoid this make sure that I_DC_MAX = I_MOT_MAX + 2A)
#define N_MOT_MAX       600 //127  //8 km/h  // [rpm] Maximum motor speed limit
...
#define INACTIVITY_TIMEOUT        8000       // Minutes of not driving until poweroff. it is not very precise.
...
// ############################ VARIANT_HOVERCAR SETTINGS ############################
  ...
  // ----------------------------------- OPTION FROM PWM MODE DO NOT USE -----------------------------------
  // #define CONTROL_PWM_RIGHT     0       // use RC PWM as input on the RIGHT cable. Number indicates priority for dual-input. Disable DEBUG_SERIAL_USART3!
  // #define PRI_INPUT1            3, -1000, 0, 1000, 100  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  // #define PRI_INPUT2            3, -1000, 0, 1000, 100  // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
...
*/
  ...
  #define PRI_INPUT1          2, -1000, 0, 1000, 100    // Disabled. TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
